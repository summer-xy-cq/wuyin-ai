...
import { Music, BookOpen, Sparkles, ChevronRight, Play, Pause, CheckCircle2, Clock, Monitor, Star, Crown, Lock, Repeat, ClipboardCheck, Calendar, Volume2, Volume1, VolumeX, Wand2 } from 'lucide-vue-next'
...
const setVolume = (val) => {
  volume.value = val
  // AI 音乐使用 toneGenerator，传统音乐使用 audioPlayer
